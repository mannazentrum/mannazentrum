            ...
            <div className="p-10">
              ...
              <form 
                onSubmit={(e) => {
                  ...
                  window.location.href = `mailto:info@mannazentrum.com?subject=Pendaftaran%20Daycare/Preschool&body=Nama:%20${name}%0AEmail:%20${email}%0APhone:%20${phone}%0A%0A${message}`;
                }}
                className="space-y-4"
              >
                <div>
      ...
      <header className="relative bg-slate-50 py-32 px-6 overflow-hidden">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="flex justify-center space-x-4">
             <button onClick={() => setShowContactForm(true)} className="bg-slate-900 text-white px-8 py-3 rounded-full font-medium hover:bg-slate-800 transition">Informasi Pendaftaran</button>
          </div>
        </div>
