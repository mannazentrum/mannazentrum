...
const PublicRegistration: React.FC<PublicRegistrationProps> = ({ onBack, websiteContent }) => {
  ...
  const renderContent = () => {
    switch (step) {
      case 0:
        return (
          <div className="text-center text-dynamic-primary">
            <h1 className="text-4xl font-bold mb-12">DAFTAR AKUN BARU</h1>
            <div className="flex justify-center gap-8">
              <div 
                className="bg-white rounded-2xl p-8 cursor-pointer border-2 border-transparent hover:border-dynamic-primary transition-all"
                onClick={() => setStep(1)}
              >
...
const ParentRegistrationForm: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-8 max-w-2xl w-full text-dynamic-primary">
      ...
      {formStep === 4 && (
        <div>
          ...
          <div className="p-4 rounded-lg space-y-2 border-2 border-dynamic-primary">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="h-32 rounded-lg mt-2 relative border-2 border-dynamic-primary">
                <SignatureCanvas 
                  ref={fatherSigRef} 
                ...
                />
                <button onClick={() => clearSignature('fatherSignature', fatherSigRef)} className="absolute top-1 right-1 px-2 text-sm rounded border-2 border-dynamic-primary text-dynamic-primary hover:bg-gray-100 transition-all">RESET</button>
              </div>
            </div>
            <div>
              ...
              <div className="h-32 rounded-lg mt-2 relative border-2 border-dynamic-primary">
                ...
                />
                <button onClick={() => clearSignature('motherSignature', motherSigRef)} className="absolute top-1 right-1 px-2 text-sm rounded border-2 border-dynamic-primary text-dynamic-primary hover:bg-gray-100 transition-all">RESET</button>
              </div>
            </div>
          </div>
          <div className="flex gap-4 mt-6">
